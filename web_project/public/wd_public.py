...
class WDPublic(object):
    ...
    def get_element_value(self,link_text,secs=30):
        return WebDriverWait(self.driver, secs, 1).until_not(ec.visibility_of_element_located((By.LINK_TEXT, link_text))
                                                                 )
    ...
    #     :param xpath: 定位信息，xpath or webElement
    #     """
    #     ActionChains(self.driver).click(self).context_click(self).perform()
